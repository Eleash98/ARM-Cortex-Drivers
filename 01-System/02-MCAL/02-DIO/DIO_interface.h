...
#define DIO_OUTPUT_SPEED_2MHZ_PP	0b0010		//2Mhz push pull
#define DIO_OUTPUT_SPEED_2MHZ_OD	0b0110		//2MHz	open drain
#define DIO_OUTPUT_SPEED_2MHZ_AFPP	0b1010		//2MHz	alternative function open drain
#define DIO_OUTPUT_SPEED_2MHZ_AFOD	0b1110		//2MHz	alternative function open drain

#define DIO_OUTPUT_SPEED_50MHZ_PP	0b0011		//50Mhz push pull
#define DIO_OUTPUT_SPEED_50MHZ_OD	0b0111		//50MHz	open drain
#define DIO_OUTPUT_SPEED_50MHZ_AFPP	0b1011		//50MHz	alternative function open drain
#define DIO_OUTPUT_SPEED_50MHZ_AFOD	0b1111		//50MHz	alternative function open drain
/*
...
#define DIO_INPUT_ANALOG		0b0000		//Input Floating
#define DIO_INPUT_FLOATING		0b0100		//Input Floating
#define DIO_INPUT_PULLUP_DOWN	0b1000		//Input Pullup/Down
